...
func _process(delta: float) -> void:
	...
	parallax_layer_3.motion_scale= Vector2(0.3,0.0)
	parallax_layer_4.motion_scale= Vector2(0.5,0.0)
	parallax_layer_5.motion_scale= Vector2(0.6,0.0)
	parallax_layer_6.motion_scale= Vector2(0.8,0.0)
	parallax_layer_7.motion_scale= Vector2(1,0)
	parallax_layer_8.motion_scale= Vector2(1.4,0)
